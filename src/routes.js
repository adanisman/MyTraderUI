...
const TableTest = React.lazy(() => import('./views/base/tables/TableTest'))
...
const Upload = React.lazy(() => import('./myComponents/admin/uploadTicker'))
...
const routes = [
  ...
  { path: '/base/tabletest', name: 'TableTest', component: TableTest },
